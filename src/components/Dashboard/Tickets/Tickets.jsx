...
const Tickets = ({setAddTicket}) => {
    ...
    return (
        <>
            <div className='breadcrumb search-bar'>
                <div className="search-box"><input type="search" placeholder='Search' /></div>
                <div className="add-btn">
                    <button onClick={(e)=>setAddTicket(e)}>Add</button>
                </div>
            </div>
