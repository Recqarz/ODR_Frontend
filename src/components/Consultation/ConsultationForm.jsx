...
const MultiStepForm = () => {
    ...
    return (
        <form onSubmit={handleSubmit}>
            <div className='first' style={{ backgroundColor: divColors.first }}>
                <div>
                    <label>Name:</label>
                    <input
                        type="text"
                ...
                <button
                    ...
                    onClick={handleNext}
                    disabled={buttonState.firstNextDisabled}
                    style={{ backgroundColor: buttonState.firstNextDisabled ? 'grey' : 'blue' }}
                >
                    Next
                </button>
            </div>

            <div className='second' style={{ backgroundColor: divColors.second }}>
                <div>
                ...
                <button
                    ...
                    onClick={handleNext}
                    disabled={buttonState.secondNextDisabled}
                    style={{ backgroundColor: buttonState.secondNextDisabled ? 'grey' : 'blue' }}
                >
                    Next
                </button>
            </div>

            <div className='third' style={{ backgroundColor: divColors.third }}>
                <div>
                ...
                <button
                    type="submit"
                    disabled={buttonState.thirdNextDisabled}
                    style={{ backgroundColor: buttonState.thirdNextDisabled ? 'grey' : 'blue' }}
                >
                    Submit
                </button>
            </div>
